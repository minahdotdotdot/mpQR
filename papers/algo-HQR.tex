...
\begin{proof}
	...
	\begin{align*}
		\|\hat{\bb{Q}}-\bb{Q}\|_F &= \left|\left|\prod_{j=1}^r (\bb{P}_{j} + \Delta \bb{P}_{j})- \prod_{j=1}^r\bb{P}_{j} \right|\right|_F\leq\left(-1+\prod_{j-1}^r(1+\tilde{\gamma}_{m-j+1})^r\right)\prod_{j=1}^n\|\bb{P}_{j}\|_2 \\
		\leq -1+(1+\tilde{\gamma}_m)^r,
	\end{align*}
