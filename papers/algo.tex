...
Since the WY representation is built with high numerical stability, the we only need to consider the FLOPs of applying $\bb{I}-\bb{W_kY_k}^{\top}$ to the blocks to the right, $[\bb{C_{k+1}} \cdots \bb{C_N}]$.
