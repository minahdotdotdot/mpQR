...
%TODO: Reviewer asks to clarify above sentence. I don't recall why we wrote this. Should we just remove it? -Minah
...
%TODO: rewrite outline of paper paragraph, and remove graph references in above paragraph.
