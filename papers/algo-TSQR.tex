...
\begin{theorem}
	...
	%& \leq \left[n\tilde{\gamma}_{m2^{-L}}+(1+n\tilde{\gamma}_{m2^{-L}})\left\{(1+n\tilde{\gamma}_{ 2n})^L-1\right\}\right]\|\bb{A}\|_F,\label{eqn:tsqrA}
	\end{align}
	...
	\begin{equation}
	\left[n\tilde{\gamma}_{m2^{-L}}+(1+n\tilde{\gamma}_{m2^{-L}})\left\{(1+n\tilde{\gamma}_{ 2n})^L-1\right\}\right] \simeq n\tilde{\gamma}_{m2^{-L}} + Ln\tilde{\gamma}_{ 2n}, %(46) in Mori
	\end{equation}
	and the right hand side of \cref{eqn:tsqrQ} can be approximated as
	\begin{equation}
	\sqrt{n}\left[(1+n\tilde{\gamma}_{m2^{-L}})(1+n\tilde{\gamma}_{ 2n})^L -1\right]\simeq \sqrt{n}\left(n\tilde{\gamma}_{m2^{-L}} + Ln\tilde{\gamma}_{ 2n}\right). %(67) in Mori
	\end{equation}
