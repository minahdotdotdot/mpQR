...
The rightmost green marker shows the error for {\tt mpBQR3} with a large block size, $r=n/2$, which is 2-3 orders of magnitude higher than its high precision variant. 
